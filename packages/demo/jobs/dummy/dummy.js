...
module.exports = {
  ...
  onRun: function (config, dependencies, jobCallback) {
    ...
    /*
     ...
     It is a good idea to cover this with unit tests as well (see test/dummy file)
     ...
     Have a look at test/dummy for an example of how to unit tests this easily by mocking easyRequest calls

     */

      jobCallback(null, "callback from dummy job");
  }
};